 ...
 * Sums the elements of a binary tree in one sexy line
 *
 */
...
/**
 * Function: sum
 * Sum the nodes of a binary tree
 * Parameters:
 *   root - Root of binary tree to sum elements of
 * Returns:
